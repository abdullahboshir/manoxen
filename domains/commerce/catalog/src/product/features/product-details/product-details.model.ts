...
import type { IProductDetails } from "./product-details.interface";
import { PhysicalPropertiesSchema, ProductAttributesSchema } from "../../product-shared/product-shared.model";
