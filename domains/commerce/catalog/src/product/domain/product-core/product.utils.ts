...
// ðŸ” 1. Find the last product by category, origin, and date
export const findLastProduct = async (
  ...
  try {
    ...
    console.error('âŒ Error finding last product:', error)
    return undefined
  }
}

// ðŸ”¢ 2. Generate the next increment (5 digits)
export const generateIncrement = (lastCode: string | undefined): string => {
  try {
    ...
    console.error('âŒ Error generating increment:', error)
    return '00001'
  }
}

// ðŸ§ª 3. Generate the SKU using CATEGORY-ORIGIN-DATE-INCREMENT
