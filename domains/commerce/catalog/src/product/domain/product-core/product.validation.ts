...
const productBodySchema = z.object({
  ...
  unit: z.preprocess((val) => val === "" ? undefined : val, objectIdSchema.optional()),
  outlet: z.preprocess((val) => val === "" ? undefined : val, objectIdSchema.optional()), // Make outlet optional
  businessUnit: z.string().min(1),
  categories: z.array(objectIdSchema).min(1),
  primaryCategory: z.preprocess((val) => val === "" ? undefined : val, objectIdSchema.optional()),
