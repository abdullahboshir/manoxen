...
import { inventoryAdapter } from '../inventory/inventory.adapter';
import { addLedgerEntryService } from '../inventory/ledger/ledger.service';
import { ContextService, outletScopedPlugin } from '@manoxen/core-util';
import { Purchase } from './purchase.model';
import { Supplier } from '../suppliers/supplier/supplier.model';
...
export const createPurchaseService = async (data: IPurchase, user?: any) => {
    ...
    try {
        ...
        if (data.outlet) {
            await ContextService.validateReferentialIntegrity(outletScopedPlugin, data.outlet);
        }
