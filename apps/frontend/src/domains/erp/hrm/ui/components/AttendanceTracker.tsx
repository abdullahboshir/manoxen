...
import { useGetAttendanceQuery, useCreateAttendanceMutation, useUpdateAttendanceMutation } from "@/domains/erp/hrm/api/attendanceApi"
...
export default function AttendanceTracker({ buId }: { buId: string }) {
    ...
    const handleCheckIn = async () => {
        try {
            await createAttendance({ businessUnit: buId }).unwrap();
