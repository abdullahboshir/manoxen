...
const CommercialSaaSSettings: React.FC<CommercialSaaSSettingsProps> = ({
  data,
  onChange,
}) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  onChange("commercialSaaS", "subscription", "defaultTier", v)
                }
              >
                <SelectTrigger>
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Automatically renew subscriptions by default.
              </p>
            </div>
            <Switch
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Allow organizations to publish to the global marketplace.
              </p>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Enable organizations to use their own top-level domains.
              </p>
            </div>
            <Switch
          ...
          <div className="pt-4 border-t space-y-3">
            ...
            <div className="space-y-2">
              {Object.entries(market.featureFlags || {}).map(
                ([key, val]: [string, any]) => (
                  <div
                    key={key}
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background/50">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Globally toggle AI-driven assistance and insights.
              </p>
            </div>
            <Switch
              checked={ai.enabled}
              onCheckedChange={(v) =>
                onChange("commercialSaaS", "aiGovernance", "enabled", v)
              }
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  onChange("commercialSaaS", "aiGovernance", "sensitivity", v)
                }
              >
                <SelectTrigger>
