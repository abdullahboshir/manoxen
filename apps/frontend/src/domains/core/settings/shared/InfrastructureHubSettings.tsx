...
const InfrastructureHubSettings: React.FC<InfrastructureHubSettingsProps> = ({
  data,
  onChange,
}) => {
  ...
  const quota =
    data?.resourceQuotaBlueprint || data?.resourceQuotaEnforcement || {};
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Allow users to log in via external identity providers.
              </p>
            </div>
            <Switch
              checked={sso.enabled}
            ...
            <div className="space-y-4 pt-2">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={sso.provider}
                    onValueChange={(v) => onChange("ssoHub", "provider", v)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={sso.issuerUrl}
                    onChange={(e) =>
                      onChange("ssoHub", "issuerUrl", e.target.value)
                    }
                    placeholder="https://..."
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    value={sso.clientId}
                    onChange={(e) =>
                      onChange("ssoHub", "clientId", e.target.value)
                    }
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      onChange("ssoHub", "callbackUrl", e.target.value)
                    }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t pt-4">
                <div className="space-y-2">
                  ...
                  <Input
                    value={sso.mapping?.emailField || "email"}
                    onChange={(e) =>
                      onChange(
                        "ssoHub",
                        "mapping",
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    value={sso.mapping?.roleField || "role"}
                    onChange={(e) =>
                      onChange("ssoHub", "mapping", "roleField", e.target.value)
                    }
                  />
                </div>
              </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                value={webhooks.deliveryMode}
                onValueChange={(v) =>
                  onChange("webhookOrchestrator", "deliveryMode", v)
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Input
                value={webhooks.signingKey}
                onChange={(e) =>
                  onChange("webhookOrchestrator", "signingKey", e.target.value)
                }
              />
            </div>
            <div className="space-y-2">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Enforce strict API versioning in requests.
              </p>
            </div>
            <Switch
              checked={api.versioningEnabled}
              onCheckedChange={(v) =>
                onChange("apiDeveloperRegistry", "versioningEnabled", v)
              }
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Default limitations for new organizations and business units.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="space-y-2 p-3 border rounded-lg bg-muted/20">
              ...
              <Input
                type="number"
                className="h-8"
                value={quota.maxMonthlyTransactions}
                onChange={(e) =>
                  onChange(
                    "resourceQuotaEnforcement",
            ...
            <div className="space-y-2 p-3 border rounded-lg bg-muted/20">
              ...
              <Input
                type="number"
                className="h-8"
                value={quota.maxApiRequestsPerMonth}
                onChange={(e) =>
                  onChange(
                    "resourceQuotaEnforcement",
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Temporarily exceed limits during peak hours.
              </p>
            </div>
            <Switch
              checked={quota.allowBursting}
              onCheckedChange={(v) =>
                onChange("resourceQuotaEnforcement", "allowBursting", v)
              }
            />
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure tenant-specific email delivery (Overrides system
            defaults).
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={smtp.port}
                onChange={(e) =>
                  onChange("smtp", "port", parseInt(e.target.value))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                value={smtp.user}
                onChange={(e) => onChange("smtp", "user", e.target.value)}
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="flex items-center justify-between p-3 border rounded-lg">
            ...
            <Switch
              checked={smtp.secure}
              onCheckedChange={(v) => onChange("smtp", "secure", v)}
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={storage.driver || "local"}
                onValueChange={(v) => onChange("storageRegistry", "driver", v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onChange("storageRegistry", "bucketName", e.target.value)
                }
              />
            </div>
          </div>
          <div className="flex items-center justify-between p-3 border rounded-lg">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                onChange("storageRegistry", "isPublic", v)
              }
            />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select
                value={backup.schedule || "daily"}
                onValueChange={(v) => onChange("backupRegistry", "schedule", v)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onChange("backupRegistry", "storagePath", e.target.value)
                }
                placeholder="/backups/tenant-1/"
              />
            </div>
            <div className="flex items-center justify-between pt-8">
              ...
              <Switch
                ...
                onCheckedChange={(v) =>
                  onChange("backupRegistry", "encryptionEnabled", v)
                }
              />
            </div>
          </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Move old records to cold storage automatically.
              </p>
            </div>
            <Switch
          ...
          {archival.enabled && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
              <div className="space-y-2">
                ...
                <Input
                  type="number"
                  value={archival.archiveAfterMonths}
                  onChange={(e) =>
                    onChange(
                      "archivalPolicy",
                      "archiveAfterMonths",
              ...
              <div className="space-y-2">
                ...
                <Input
                  value={archival.coldStorageProvider}
                  onChange={(e) =>
                    onChange(
                      "archivalPolicy",
                      "coldStorageProvider",
                  ...
                  placeholder="e.g. Glacier, Azure Archive"
                />
              </div>
              <div className="flex items-center gap-2 pt-2">
                <Switch
                  checked={archival.compressionEnabled}
                  onCheckedChange={(v) =>
                    onChange("archivalPolicy", "compressionEnabled", v)
                  }
                />
              ...
              <div className="flex items-center gap-2 pt-2">
                <Switch
                  checked={archival.deleteAfterArchive}
                  onCheckedChange={(v) =>
                    onChange("archivalPolicy", "deleteAfterArchive", v)
                  }
                />
                <Label className="text-xs">
                  Delete From Primary DB After Archive
                </Label>
              </div>
            </div>
          )}
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between p-3 border rounded-lg bg-background">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  Distribute traffic across multiple cluster nodes.
                </p>
              </div>
              <Switch
                checked={data?.infrastructureHub?.enableLoadBalancer || false}
                onCheckedChange={(v) =>
                  onChange("infrastructureHub", "enableLoadBalancer", v)
                }
              />
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      onChange("infrastructureHub", "lbType", v)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    value={
                      data?.infrastructureHub?.clusterNodes?.join(", ") || ""
                    }
                    onChange={(e) =>
                      onChange(
                        "infrastructureHub",
            ...
            <div className="pt-4 border-t space-y-2">
              ...
              <Select
                value={
                  data?.infrastructureHub?.cacheLayer?.driver || "internal"
                }
                onValueChange={(v) =>
                  onChange("infrastructureHub", "cacheLayer", "driver", v)
                }
              >
                <SelectTrigger>
                  <SelectValue />
