...
import SystemCoreSettings from "@/domains/core/settings/shared/SystemCoreSettings"
import ObservabilitySettings from "@/domains/core/settings/shared/ObservabilitySettings"
import GatewayGovernanceSettings from "@/domains/core/settings/shared/GatewayGovernanceSettings"
import StorageRegistrySettings from "@/domains/core/settings/shared/StorageRegistrySettings"
import InternationalizationSettings from "@/domains/core/settings/shared/InternationalizationSettings"
import InfrastructureClusterSettings from "@/domains/core/settings/shared/InfrastructureClusterSettings"
...
export function SystemSettingsInterface() {
    ...
    // If I call onNestedChange('core', 'smtp', 'host', val), that fits handleDeepNestedChange manoxen if I rename the prop in child.
