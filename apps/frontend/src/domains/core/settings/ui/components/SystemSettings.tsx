...
import { IPlatformSettings, IBusinessUnitSettings, IOrganizationSettings } from "@/types/settings"

interface SystemSettingsProps {
    data: IPlatformSettings | IBusinessUnitSettings | IOrganizationSettings;
