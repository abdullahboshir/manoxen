...
export function OutletMultiSelect({ buId, selectedOutlets, onChange }: OutletMultiSelectProps) {
    const [open, setOpen] = React.useState(false)
    const { data: outletsData, isLoading } = useGetOutletsQuery({ businessUnit: buId })
