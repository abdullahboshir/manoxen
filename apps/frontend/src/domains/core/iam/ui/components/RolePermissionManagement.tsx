    ...
    useEffect(() => {
        if (rolesData) {
            ...
            if (viewScope === 'platform') {
                ...
                fetchedRoles = fetchedRoles.filter(r => r.roleScope === RoleScope.ORGANIZATION);
            } else if (viewScope === 'business') {
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    ...
                                                    <SelectItem value={RoleScope.ORGANIZATION}>Organization (Tenant)</SelectItem>
                                                                ...
                                                                <div className="flex items-center justify-between mb-1">
                                                                    <div className="flex flex-col overflow-hidden">
                                                                        ...
                                                                        <div className='w-full flex gap-1'>
                                                                            ...
                                                                            {role.roleScope === RoleScope.ORGANIZATION && <Badge className="text-[10px] h-5 bg-blue-600">Organization</Badge>}
