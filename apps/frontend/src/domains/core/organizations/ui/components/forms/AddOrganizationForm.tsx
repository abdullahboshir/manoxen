...
export function AddOrganizationForm() {
  ...
  const validateStep = () => {
    ...
    if (currentStep === 2) {
      ...
      if (!(formData.location as any).address)
    ...
    if (currentStep === 3) {
      if (!formData.legalRepresentative.name)
        return "Legal Representative Name is required";
      const totalShares = formData.shareholders.reduce(
        (sum: number, s: any) => sum + (s.sharePercentage || 0),
        0,
      );
      if (formData.shareholders.length > 0 && totalShares !== 100)
        return "Share percentages must total 100%";
    }
    return null;
  };
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("branding.description", e.target.value)
                    }
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("branding.tagline", e.target.value)
                    }
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("branding.logoUrl", e.target.value)
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("branding.bannerUrl", e.target.value)
                      }
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("branding.faviconUrl", e.target.value)
                      }
                    />
                  </div>
                </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("contact.supportPhone", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateField("contact.website", e.target.value)
                    }
                  />
                </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Primary authorized person for legal matters
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("legalRepresentative.name", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField(
                          "legalRepresentative.designation",
                          e.target.value,
                        )
                      }
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField(
                          "legalRepresentative.contactPhone",
                          e.target.value,
                        )
                      }
                    />
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField("legalRepresentative.email", e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateField(
                          "legalRepresentative.nationalId",
                          e.target.value,
                        )
                      }
                    />
            ...
            <StakeholderManager
              ...
              onChange={(shareholders) =>
                updateField("shareholders", shareholders)
              }
            />
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <dl className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <dd className="font-medium">
                    {(formData.location as any).timezone}
                  </dd>
                </dl>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {formData.shareholders.length} Shareholders,{" "}
                  {formData.directors.length} Directors
                </p>
              </div>
              ...
              <div>
                ...
                <dl className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <dd className="font-medium">
                    {formData.legalRepresentative.designation}
                  </dd>
                  <dt className="text-muted-foreground">Phone:</dt>
                  <dd className="font-medium">
                    {formData.legalRepresentative.contactPhone}
                  </dd>
                </dl>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(formData.activeModules).map(
                    ([key, isActive]) => {
                      if (!isActive) return null;
                      return (
                        <span
                          key={key}
                          className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-primary text-primary-foreground hover:bg-primary/80 uppercase"
                        >
                          {key}
                        </span>
                      );
