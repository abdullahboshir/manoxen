...
export function OutletForm({ preSelectedSlug, initialData, isEditMode = false }: OutletFormProps) {
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            const derivedOrganizationId = organizationId || localStorage.getItem("active-organization-id") || selectedBU?.organization?._id || selectedBU?.organization || selectedBU?.organizationId;
            ...
            const redirectUrl = organizationId ? `${targetPath}?organization=${organizationId}` : targetPath;
