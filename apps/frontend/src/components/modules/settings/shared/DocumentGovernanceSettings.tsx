                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            ...
                            <p className="text-sm text-muted-foreground">Automatically attach digital manoxen to invoices</p>
                        </div>
                        <Switch
                    ...
                    <div className="space-y-2">
                        <Label>Digital Manoxen URL</Label>
                        <Input
                            ...
                            placeholder="https://storage.com/manoxen.png"
                        />
                    </div>
