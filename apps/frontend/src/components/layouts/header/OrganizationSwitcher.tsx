...
export function OrganizationSwitcher({ currentOrganizationId, companies }: OrganizationSwitcherProps) {
    ...
    return (
        <div className="flex items-center gap-2">
            <Select value={currentOrganizationId || "all"} onValueChange={handleSwitchOrganization}>
