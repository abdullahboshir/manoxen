...
export function OutletSwitcher({
    ...
    const handleSwitchOutlet = (outletId: string) => {
        ...
        const effectiveOrganizationRaw = effectiveOrganizationId || activeUnit?.organization?._id || activeUnit?.organization;
        const effectiveOrganization = (effectiveOrganizationRaw && typeof effectiveOrganizationRaw === 'object')
            ? (effectiveOrganizationRaw._id?.toString() || effectiveOrganizationRaw.id?.toString() || effectiveOrganizationRaw.toString())
            : effectiveOrganizationRaw?.toString();

        if (effectiveOrganization && effectiveOrganization !== '[object Object]') params.set('organization', effectiveOrganization);
