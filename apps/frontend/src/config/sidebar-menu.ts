    ...
    dynamic: [
      ...
      MENU_MODULES.POS_TERMINAL,
      {
        ...
        children: [
          {
            title: "Products",
            path: ROUTE_PATHS.CATALOG.PRODUCT.ROOT,
      ...
      },
      {
        ...
        children: [
          ...
          {
            title: "Delivery",
            path: ROUTE_PATHS.SALES.DELIVERY,
      ...
      { ...MENU_MODULES.STOREFRONT, resource: undefined },
      {
        ...
        children: [
          ...
          },
          {
            title: "Adjustments",
            path: ROUTE_PATHS.INVENTORY.ADJUSTMENTS,
            resource: RESOURCE_KEYS.ADJUSTMENT,
            action: ACTION_KEYS.ADJUST,
          },
        ],
      },
      { ...MENU_MODULES.MARKETING, resource: undefined },
      {
        ...
        children: [
          ...
          {
            title: "Reviews",
            path: ROUTE_PATHS.CUSTOMERS.REVIEWS,
            resource: RESOURCE_KEYS.REVIEW,
          },
        ],
      },
      ...
      { ...MENU_MODULES.REPORTS, resource: RESOURCE_KEYS.REPORT },
      {
        ...
        children: [
          {
            title: "Payments",
            path: ROUTE_PATHS.FINANCE.PAYMENTS,
            resource: RESOURCE_KEYS.PAYMENT,
          },
          {
            title: "Settlements",
            path: ROUTE_PATHS.FINANCE.SETTLEMENTS,
            resource: RESOURCE_KEYS.SETTLEMENT,
          },
          {
            title: "Payouts",
            path: ROUTE_PATHS.FINANCE.PAYOUTS,
            resource: RESOURCE_KEYS.PAYOUT,
          },
          {
            title: "Fraud Detection",
            path: ROUTE_PATHS.FINANCE.FRAUD,
            resource: RESOURCE_KEYS.FRAUD_DETECTION,
          },
          {
            title: "Audit Logs",
            path: ROUTE_PATHS.FINANCE.AUDIT_LOGS,
...
export const getSidebarMenu = (
    ...
    return items.map((item) => {
      ...
      if (newItem.path !== undefined) {
        if (newItem.path === "") {
          ...
          newItem.path &&
          !newItem.path.startsWith("/") &&
          !newItem.path.startsWith("http")
        ) {
    ...
    if (isPrivileged) {
      ...
      rawOutletMenu = [
        ...
        },
        {
          ...
          children: [
            { title: "Customer Registry", path: ROUTE_PATHS.CUSTOMERS.ROOT },
          ],
        },
        MENU_MODULES.REPORTS,
        MENU_MODULES.OUTLET_SETTINGS,
  ...
  const appendOrganizationToMenu = (items: any[]): any[] => {
    ...
    return items.map((item) => {
      ...
      if (newItem.path) {
        ...
        if (!newItem.path.includes("organization="))
          newItem.path = `${newItem.path}${separator}organization=${organizationId}`;
      }
      if (newItem.children)
        newItem.children = appendOrganizationToMenu(newItem.children);
      return newItem;
    });
  };
  ...
  if (
    ...
    Object.prototype.hasOwnProperty.call(sidebarMenuConfig.menus, role)
  ) {
    roleMenu =
      sidebarMenuConfig.menus[role as keyof typeof sidebarMenuConfig.menus];
