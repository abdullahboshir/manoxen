...
import { useCreateAdjustmentMutation } from "@/features/inventory/api/inventoryApi";
import { useGetProductsQuery } from "@/features/catalog/api/productApi"; // To select product
