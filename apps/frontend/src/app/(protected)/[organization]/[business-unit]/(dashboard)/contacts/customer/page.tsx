  ...
  useEffect(() => {
    if (allUsersResponse) {
      ...
      if (Array.isArray(resData)) {
        ...
        const possibleArray = Object.values(resData.data).find((val) =>
          Array.isArray(val),
        );
      ...
      if (!isSuperAdmin && currentBusinessUnit) {
        filteredUsers = allUsers.filter((user: any) => {
          ...
          return user.businessUnits.some((bu: any) => {
            const buId =
              typeof bu === "string" ? bu : bu.id || bu.slug || bu._id;
            return (
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <DynamicDataTable
        ...
        onView={handleView}
        onRefresh={() => {
          /* automatic refetch via tag invalidation or polling if needed */
        }}
