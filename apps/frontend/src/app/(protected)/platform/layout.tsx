...
import { isPlatformLevel, isOrganizationOwner } from "@/config/auth-constants";
 ...
 * Organization Owners should use /organization route instead
 */
export default function GlobalLayout({ children }: GlobalLayoutProps) {
  ...
  // Check if user is organization owner (should redirect to /organization)
  const isOrganizationOwnerUser = useMemo(() => {
