...
This document defines the strict architectural boundaries and development discipline for the Manoxen POS system. Any deviation from these rules must be justified and explicitly approved.
