...
import { createCustomerService, createStaffService } from "./user.service";
import { sendImageToCloudinary } from "#core/utils/file-upload";
import { USER_ROLE } from "@manoxen/iam-core";
import { resolveBusinessUnitIds } from "#core/utils/mutation-helper";
...
export const createUserController = catchAsync(async (req, res) => {
    ...
    if (roleName === 'CUSTOMER') {
        ...
        try {
            ...
            // No, I can't easily change service manoxen across app.
