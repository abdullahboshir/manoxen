...
/* -------------------------------------------------------------------------- */
/* 2ï¸âƒ£  Helper â€“ parse boolean & pagination                                 */
/* -------------------------------------------------------------------------- */
 ...
 * â€“ à¦•à§à¦¯à¦¾à¦¶â€‘à¦¡ à¦°à§‡à¦œà¦²à¦­à¦¡ à¦ªà¦¾à¦°à¦®à¦¿à¦¶à¦¨, à¦°à§‹à¦²â€‘à¦‡à¦¨à¦¹à§‡à¦°à¦¿à¦Ÿâ€‘à¦¡à¦¿à¦ªà¦¥ à¦“ à¦—à§à¦°à§à¦ªâ€‘à¦¬à¦¾à¦‡â€‘à¦°à¦¿à¦¸à§‹à¦°à§à¦¸
 */
 ...
 * â€“ à¦°à¦¿à¦•à§‹à¦¯à¦¼à§‡à¦¸à§à¦Ÿâ€‘à¦¬à¦¡à¦¿: { resource, action }
 */
export const checkUserPermission = catchAsync(
  async (req: Request, res: Response) => {
    const { resource, action } = checkPermissionBodySchema.parse(req.body);

    // authenticationâ€‘middlewareâ€‘à¦•à§‡ à¦§à¦°à§‡à¦›à¦¿ à¦¯à§‡ `req.user` à¦à¦•à¦Ÿà¦¿ object
