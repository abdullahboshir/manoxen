import { AutomationRule, type IAutomationRule, type TriggerType } from "./automation-rule.model";
import { AppError, QueryBuilder } from "@manoxen/core-util";
import { resolveBusinessUnitQuery } from "#core/utils/query-helper";
 ...
 * Logic Operations
 */
import { QueueService } from "#app/modules/platform/index";
import { QUEUE_NAMES } from "#app/modules/platform/index";
