...
import type { IBusinessUnitCoreDocument, IBusinessUnitCoreModel } from "./business-unit.interface";
...
const BusinessUnit = model<IBusinessUnitCoreDocument, any>(
  "BusinessUnit",
  businessUnitCoreSchema as any
);
