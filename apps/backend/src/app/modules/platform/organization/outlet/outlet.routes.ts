...
import { OutletSettingsRoutes } from "./settings/settings.routes";
...
const validateOutletId = (req: express.Request, res: express.Response, next: express.NextFunction): void => {
