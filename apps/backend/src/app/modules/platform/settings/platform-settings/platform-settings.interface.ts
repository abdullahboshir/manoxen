...
import type { ISharedBranding, ISharedSecurityHardening, ISharedCompliance, ISharedSSOHub, ISharedWebhookOrchestrator, ISharedIntegrationRegistry, ISharedResourceQuota, ISharedRoleBlueprint, ISharedLegalGovernance, ISharedCommercialSaaS, ISharedInternationalizationHub, ISharedMaintenancePolicy, ISharedAPIDeveloperRegistry } from "../../organization/shared/common.interface";
