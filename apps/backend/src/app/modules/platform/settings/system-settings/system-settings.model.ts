...
import type { ISystemSettingsDocument, ISystemSettingsModel } from "./system-settings.interface";

import { moduleMapSchema, systemCoreSchema, observabilitySchema, infrastructureHubSchema, storageRegistrySchema, gatewayGovernanceSchema, internationalizationHubSchema } from "../../organization/shared/common.schema";
import { DEFAULT_BACKUP_REGISTRY, DEFAULT_GATEWAY_GOVERNANCE, DEFAULT_INTERNATIONALIZATION, DEFAULT_MODULE_MAP, DEFAULT_OBSERVABILITY, DEFAULT_SMTP_CONFIG, DEFAULT_STORAGE_REGISTRY } from "../../organization/shared/common.defaults";
