...
import type { ISharedGatewayGovernance, ISharedInfrastructureHub, ISharedInternationalizationHub, ISharedModuleMap, ISharedObservability, ISharedStorageRegistry, ISharedSystemCore } from "../../organization/shared/common.interface";
