export const RESOURCE_SCOPE_MAP: Record<string, string> = {
    // ðŸŒ Global / Platform Level (Infrastructural & SaaS)
    systemConfig: "global",
    ...
    // ðŸ¢ Organization / Tenant Level (Shared across Business Units)
    ...
    // ðŸ’¼ Business Unit / Context Level (The "Business" Logic)
    report: "business",
    dashboard: "business",
    payment: "business",
    expense: "business",
    ...
    // ðŸ“¦ ERP & Inventory (Usually Business scope, can be Warehouse if granular)
    product: "business",
    category: "business",
    brand: "business",
    variant: "business",
    ...
    // ðŸª Outlet / Scoped Level (Direct POS usage)
    outlet: "outlet",
    storefront: "outlet",
    terminal: "outlet",
    cashRegister: "outlet",
