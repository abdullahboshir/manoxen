...
import { TenantService, type ITenantContext } from "#core/services/tenant.service";
...
export const tenantMiddleware = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const orgIdHeader = (req.headers['x-organization-id'] || req.headers['x-organization-id']) as string | undefined;
