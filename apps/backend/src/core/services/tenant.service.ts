import type { ITenantConfig } from "#app/modules/platform/organization/organization.interface";
import { Organization } from "#app/modules/platform/organization/organization.model";
