import { CashRegister } from "../../infrastructure/persistence/mongoose/cash-register.model";
...
import type { ICashRegister } from "#domain/pos/domain/entities/cash-register.entity.js";
