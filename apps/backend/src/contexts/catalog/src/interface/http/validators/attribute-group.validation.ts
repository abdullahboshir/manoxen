...
export const createAttributeGroupValidationSchema = z.object({
    body: z.object({
        ...
        availableModules: z.array(z.enum(['pos', 'erp', 'hrm', 'commerce', 'crm', 'logistics', 'marketing', 'integrations', 'system']))
...
export const updateAttributeGroupValidationSchema = z.object({
    body: z.object({
        ...
        description: z.string().optional(),
        availableModules: z.array(z.enum(['pos', 'erp', 'hrm', 'commerce', 'crm', 'logistics', 'marketing', 'integrations', 'system'])).optional(),
        fields: z.array(attributeFieldSchema).optional(),
