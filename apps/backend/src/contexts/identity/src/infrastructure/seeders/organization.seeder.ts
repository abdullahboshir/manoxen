import { PermissionSourceObj, RoleScope, USER_ROLE } from "@manoxen/iam-core";
...
export const getOrganizationRoleConfigs = (get: (r: string) => Types.ObjectId | null) => [
    {
        ...
        permissionGroups: [
            ...
            get(PermissionSourceObj.domain),
            get(PermissionSourceObj.ssl),
            get(PermissionSourceObj.media),
            get(PermissionSourceObj.folder),
            // Governance
            ...
            get(PermissionSourceObj.journal),
            get(PermissionSourceObj.ledger),
            get(PermissionSourceObj.balanceSheet),
