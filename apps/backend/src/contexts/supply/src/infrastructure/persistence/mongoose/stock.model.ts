...
import type { IStockDocument, IOutletStock } from "../../../domain/entities/stock.entity";

import { contextScopePlugin } from "@manoxen/core-util";
import { InventoryBaseSchema } from "@manoxen/catalog";
...
// ==================== MODEL ====================
export const Stock = (mongoose.models.Stock as any) || model<IStockDocument>('Stock', stockSchema);
