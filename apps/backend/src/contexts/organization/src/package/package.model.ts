...
import type { IPackage, PackageModel, IModuleConfig } from "./package.interface";
...
const packageSchema = new Schema<IPackage, PackageModel>({
    ...
    appliesTo: { type: String, enum: ['organization', 'business-unit'], default: 'organization' },
    ...
    moduleAccess: {
        ...
        commerce: { type: moduleConfigSchema, default: () => ({ enabled: false }) },
