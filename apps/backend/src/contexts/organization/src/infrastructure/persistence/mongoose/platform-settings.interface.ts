...
import type { 
    ...
    ISharedCompliance, 
    ISharedSSOHub, 
    ISharedWebhookOrchestrator, 
    ISharedIntegrationRegistry, 
    ISharedResourceQuota, 
    ISharedRoleBlueprint, 
    ISharedLegalGovernance, 
    ISharedCommercialSaaS, 
    ISharedInternationalizationHub, 
    ISharedMaintenancePolicy, 
    ISharedAPIDeveloperRegistry 
