...
import type { IOrganization } from "../../../domain/entities/organization.entity";
...
const organizationSchema = new Schema<IOrganizationDocument, IOrganizationModel>(
    {
        ...
        activeModules: {
            ...
            accounting: { type: Boolean, default: true }, // Changed from finance
            reports: { type: Boolean, default: false },  // Changed from marketing
