...
import type { IOutletSettings, IOutletSettingsModel } from "./outlet-settings.interface";
import { 
    operatingHoursSchema, paymentSettingsSchema, posHardwareSchema, 
    complianceSchema, displayPolicySchema, checkoutPolicySchema, 
    serviceAreaSchema, cashierRegistrySchema, brandingSchema, 
    inventoryPolicySchema, pricingPolicySchema, fulfillmentPolicySchema, 
    seoPolicySchema, integrationRegistrySchema, legalGovernanceSchema, 
    smtpConfigSchema, prefixPolicySchema, taxIntelligenceSchema, 
    contactSchema, communicationChannelSchema 
