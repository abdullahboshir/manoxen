...
export const DEFAULT_LEGAL_GOVERNANCE: ISharedLegalGovernance = {
    ...
    termsUrl: "https://manoxen.com/terms",
    privacyUrl: "https://manoxen.com/privacy",
    cookiePolicyUrl: "https://manoxen.com/cookie-policy",
    version: "1.0.0",
...
export const DEFAULT_MODULE_MAP: ISharedModuleMap = {
    pos: true, erp: true, hrm: true, commerce: true, crm: true,
