...
import { BusinessUnitService } from "../../../application/services/business-unit.service";

export const createBusinessUnitController = catchAsync(
...
export const getAllBusinessUnitsController = catchAsync(
  async (req: Request, res: Response) => {
...
export const deleteBusinessUnitController = catchAsync(
  async (req: Request, res: Response) => {
...
export const getBusinessUnitByIdController = catchAsync(
  async (req: Request, res: Response) => {
    const businessUnitId = req.params["businessUnitId"] as string;
    console.log("dddddddddddddddddddddddddd", businessUnitId);
    if (!businessUnitId) {
      throw new Error("Business Unit ID is required");
    }
...
export const updateBusinessUnitController = catchAsync(
  async (req: Request, res: Response) => {
    const businessUnitId = req.params["businessUnitId"] as string;
    if (!businessUnitId) {
      throw new Error("Business Unit ID is required");
    ...
    const data = await BusinessUnitService.updateBusinessUnit(
      businessUnitId,
      updateData,
    );
    ApiResponse.success(
...
export const getBusinessUnitStatsController = catchAsync(
  async (req: Request, res: Response) => {
    const businessUnitId = req.params["businessUnitId"] as string;
    ...
    const data = await BusinessUnitService.getDashboardStats(
      businessUnitId,
      outletId as string,
    );
