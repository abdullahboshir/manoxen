...
function inferModule(path: string): 'pos' | 'erp' | 'hrm' | 'commerce' | 'crm' | 'logistics' | 'system' {
    ...
    if (lowerPath.includes('/order') || lowerPath.includes('/product') || lowerPath.includes('/storefront')) return 'commerce';
