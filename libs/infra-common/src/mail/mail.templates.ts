      ...
      <body>
          <div class="container">
              ...
              <div class="content">
                  ...
                  <p>Congratulations! Your organization, <strong>${data.organizationName}</strong>, has been successfully registered on the <strong>Manoxen POS Platform</strong>.</p>
                  ...
                  <p>Best Regards,<br><strong>Manoxen Team</strong></p>
              </div>
              <div class="footer">
                  <p>&copy; ${new Date().getFullYear()} Manoxen. All rights reserved.</p>
              </div>
          </div>
      </body>
      </html>
          ...
          <div class="container">
              ...
              <div class="content">
                  ...
                  <div style="text-align: center; margin-top: 30px;">
                      <a href="https://manoxen.com/login" style="background: #805ad5; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login Now</a>
                  </div>
